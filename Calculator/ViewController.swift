...
class ViewController: UIViewController {                // class viewController extends from                                                                                                UIViewController
    ...
    var operation = 0                                   // +
    var numberOnScreen = 0.0                   //15   number that we entered after the operator that is currently on the screen
